...
user1 = User.create(name: "Thinh", email:"lethinhcdt@gmail.com", password: "123456", image_url: "https://organicthemes.com/demo/profile/files/2012/12/profile_img.png")
p user1

user2 = User.create({name: "Thinh Le", email:"tibi01993@gmail.com", password: "654321", image_url: "http://www.hvac2000.com/wp-content/uploads/2016/05/Profile-Pictures-2.jpg"})
p user2
